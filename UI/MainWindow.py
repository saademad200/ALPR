...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Initialize ALPR tab variables
        self.start_processing_btn, self.stop_processing_btn, self.browse_btn, self.play_btn, self.browse_mode, \
            self.stream_mode, self.validate_button, self.status_label, self.ip_cam_input, self.stream \
            = tab_widget.initialize_anpr_content()

        # Initialize VIEW REPORT tab variables
        self.export_btn, self.reset_btn, self.license_input, self.score_input, self.media_type_combo, \
            self.date_from_picker, self.date_to_picker, self.filter_button, self.table \
            = tab_widget.initialize_report_content()
    ...
    def initialize_ui(self):
        ...
        self.validate_button.clicked.connect(self.validate_ip_cam)
